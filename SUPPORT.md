# Getting help with connectapi

Thanks for using connectapi! Before filing an issue, there are a few
...
- If it’s a question: start with
  [forum.posit.co](https://forum.posit.co/), and/or StackOverflow. There
  are more people there to answer questions.

- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/posit-dev/connectapi/issues/new).
...
requests](https://github.com/posit-dev/connectapi/issues) to make sure
