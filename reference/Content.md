...
### Method [`get_bundles()`](https://posit-dev.github.io/connectapi/reference/get_bundles.md)
...
### Method [`permissions()`](https://posit-dev.github.io/connectapi/reference/permissions.md)
...
### Method [`deploy()`](https://posit-dev.github.io/connectapi/reference/deploy.md)
