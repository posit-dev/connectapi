...
-\>
[`connectapi::Variant`](https://posit-dev.github.io/connectapi/reference/VariantR6.md)
-\> `VariantTask`
...
- [`connectapi::Variant$add_subscribers()`](https://posit-dev.github.io/connectapi/reference/Variant.html#method-add_subscribers)
- [`connectapi::Variant$get_dashboard_url()`](https://posit-dev.github.io/connectapi/reference/Variant.html#method-get_dashboard_url)
- [`connectapi::Variant$get_schedule()`](https://posit-dev.github.io/connectapi/reference/Variant.html#method-get_schedule)
- [`connectapi::Variant$get_schedule_remote()`](https://posit-dev.github.io/connectapi/reference/Variant.html#method-get_schedule_remote)
- [`connectapi::Variant$get_subscribers()`](https://posit-dev.github.io/connectapi/reference/Variant.html#method-get_subscribers)
- [`connectapi::Variant$get_url()`](https://posit-dev.github.io/connectapi/reference/Variant.html#method-get_url)
- [`connectapi::Variant$get_url_rev()`](https://posit-dev.github.io/connectapi/reference/Variant.html#method-get_url_rev)
- [`connectapi::Variant$get_variant_remote()`](https://posit-dev.github.io/connectapi/reference/Variant.html#method-get_variant_remote)
- [`connectapi::Variant$jobs()`](https://posit-dev.github.io/connectapi/reference/Variant.html#method-jobs)
- [`connectapi::Variant$remove_subscriber()`](https://posit-dev.github.io/connectapi/reference/Variant.html#method-remove_subscriber)
- [`connectapi::Variant$render()`](https://posit-dev.github.io/connectapi/reference/Variant.html#method-render)
- [`connectapi::Variant$renderings()`](https://posit-dev.github.io/connectapi/reference/Variant.html#method-renderings)
- [`connectapi::Variant$send_mail()`](https://posit-dev.github.io/connectapi/reference/Variant.html#method-send_mail)
- [`connectapi::Variant$update_variant()`](https://posit-dev.github.io/connectapi/reference/Variant.html#method-update_variant)
