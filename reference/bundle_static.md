...
#> Bundling directory (/tmp/RtmpBBoQ1m/bundledir22311fbab352)
#> Posit Connect Bundle: 
#>   Path: /tmp/RtmpBBoQ1m/bundle22317a820037.tar.gz
#>   Size: 23.9K
#> 
#> bundle_path("/tmp/RtmpBBoQ1m/bundle22317a820037.tar.gz")
#> 
```
