...
#> Bundling directory (/tmp/RtmpJyUwL5/bundledir24aa742fa8c0)
#> Posit Connect Bundle: 
#>   Path: /tmp/RtmpJyUwL5/bundle24aaaa985ad.tar.gz
#>   Size: 23.9K
#> 
#> bundle_path("/tmp/RtmpJyUwL5/bundle24aaaa985ad.tar.gz")
#> 
```
