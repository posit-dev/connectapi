...
#> Bundling directory (/tmp/RtmprxkLae/bundledir235a4869551f)
#> Posit Connect Bundle: 
#>   Path: /tmp/RtmprxkLae/bundle235a5bc2e5d1.tar.gz
#>   Size: 23.9K
#> 
#> bundle_path("/tmp/RtmprxkLae/bundle235a5bc2e5d1.tar.gz")
#> 
```
