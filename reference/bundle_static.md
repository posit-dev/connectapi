...
#> Bundling directory (/tmp/RtmpbXCUVj/bundledir238342d5418b)
#> Posit Connect Bundle: 
#>   Path: /tmp/RtmpbXCUVj/bundle2383468c8fda.tar.gz
#>   Size: 23.9K
#> 
#> bundle_path("/tmp/RtmpbXCUVj/bundle2383468c8fda.tar.gz")
#> 
```
