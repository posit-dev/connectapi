...
#> Bundling directory (/tmp/Rtmp5UQN9W/bundledir223a636bab15)
#> Posit Connect Bundle: 
#>   Path: /tmp/Rtmp5UQN9W/bundle223a7a3b487d.tar.gz
#>   Size: 23.9K
#> 
#> bundle_path("/tmp/Rtmp5UQN9W/bundle223a7a3b487d.tar.gz")
#> 
```
