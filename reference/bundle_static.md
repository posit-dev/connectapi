...
#> Bundling directory (/tmp/RtmpDTzqxY/bundledir23574be68cde)
#> Posit Connect Bundle: 
#>   Path: /tmp/RtmpDTzqxY/bundle23571a7ddbdc.tar.gz
#>   Size: 23.9K
#> 
#> bundle_path("/tmp/RtmpDTzqxY/bundle23571a7ddbdc.tar.gz")
#> 
```
