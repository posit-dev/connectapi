...
#> Bundling directory (/tmp/Rtmp6FVN3g/bundledir23926a09c2e5)
#> Posit Connect Bundle: 
#>   Path: /tmp/Rtmp6FVN3g/bundle2392120d0b8f.tar.gz
#>   Size: 23.9K
#> 
#> bundle_path("/tmp/Rtmp6FVN3g/bundle2392120d0b8f.tar.gz")
#> 
```
