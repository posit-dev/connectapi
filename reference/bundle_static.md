...
#> Bundling directory (/tmp/RtmpiqhyDa/bundledir22b8533068e9)
#> Posit Connect Bundle: 
#>   Path: /tmp/RtmpiqhyDa/bundle22b8d375231.tar.gz
#>   Size: 23.9K
#> 
#> bundle_path("/tmp/RtmpiqhyDa/bundle22b8d375231.tar.gz")
#> 
```
