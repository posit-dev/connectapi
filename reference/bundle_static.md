...
#> Bundling directory (/tmp/RtmpBAlIoZ/bundledir249826979f8a)
#> Posit Connect Bundle: 
#>   Path: /tmp/RtmpBAlIoZ/bundle24982c46ef5.tar.gz
#>   Size: 23.9K
#> 
#> bundle_path("/tmp/RtmpBAlIoZ/bundle24982c46ef5.tar.gz")
#> 
```
