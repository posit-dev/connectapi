...
#> Bundling directory (/tmp/RtmpmsAuLk/bundledir229d4a08cc8a)
#> Posit Connect Bundle: 
#>   Path: /tmp/RtmpmsAuLk/bundle229d5a6a36e1.tar.gz
#>   Size: 23.9K
#> 
#> bundle_path("/tmp/RtmpmsAuLk/bundle229d5a6a36e1.tar.gz")
#> 
```
