...
[`connectapi::content_update()`](https://posit-dev.github.io/connectapi/dev/reference/content_update.md).
...
#> 
#> Uploading bundle
#> Warning: 'raw = FALSE' but '/home/runner/work/connectapi/connectapi/docs/dev/reference' is not a regular file
#> Warning: cannot open file '/home/runner/work/connectapi/connectapi/docs/dev/reference': it is a directory
