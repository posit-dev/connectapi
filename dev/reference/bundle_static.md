...
#> Bundling directory (/tmp/RtmpGvNOHO/bundledir23fb268206c6)
#> Posit Connect Bundle: 
#>   Path: /tmp/RtmpGvNOHO/bundle23fb604c9fb2.tar.gz
#>   Size: 23.9K
#> 
#> bundle_path("/tmp/RtmpGvNOHO/bundle23fb604c9fb2.tar.gz")
#> 
```
