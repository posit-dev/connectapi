...
#> Bundling directory (/tmp/RtmpMoYMcI/bundledir228f1a8086a5)
#> Posit Connect Bundle: 
#>   Path: /tmp/RtmpMoYMcI/bundle228f15ce3300.tar.gz
#>   Size: 23.9K
#> 
#> bundle_path("/tmp/RtmpMoYMcI/bundle228f15ce3300.tar.gz")
#> 
```
