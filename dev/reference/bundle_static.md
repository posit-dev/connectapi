...
#> Bundling directory (/tmp/RtmpUUD3mA/bundledir228a3fe80edc)
#> Posit Connect Bundle: 
#>   Path: /tmp/RtmpUUD3mA/bundle228a5e1f9b9c.tar.gz
#>   Size: 23.9K
#> 
#> bundle_path("/tmp/RtmpUUD3mA/bundle228a5e1f9b9c.tar.gz")
#> 
```
