...
#> Bundling directory (/tmp/RtmpyMiKBV/bundledir23bb7ee7a37e)
#> Posit Connect Bundle: 
#>   Path: /tmp/RtmpyMiKBV/bundle23bb64c2ddc1.tar.gz
#>   Size: 23.9K
#> 
#> bundle_path("/tmp/RtmpyMiKBV/bundle23bb64c2ddc1.tar.gz")
#> 
```
