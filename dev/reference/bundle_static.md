...
#> Bundling directory (/tmp/Rtmp9LLsY0/bundledir238168a9593e)
#> Posit Connect Bundle: 
#>   Path: /tmp/Rtmp9LLsY0/bundle2381332ba930.tar.gz
#>   Size: 23.9K
#> 
#> bundle_path("/tmp/Rtmp9LLsY0/bundle2381332ba930.tar.gz")
#> 
```
