...
#> Bundling directory (/tmp/RtmpggsqCS/bundledir24413aa76aff)
#> Posit Connect Bundle: 
#>   Path: /tmp/RtmpggsqCS/bundle24413fbc7298.tar.gz
#>   Size: 23.9K
#> 
#> bundle_path("/tmp/RtmpggsqCS/bundle24413fbc7298.tar.gz")
#> 
```
