...
#> Bundling directory (/tmp/RtmpYLU9FH/bundledir22452abee738)
#> Posit Connect Bundle: 
#>   Path: /tmp/RtmpYLU9FH/bundle22455ffbb00d.tar.gz
#>   Size: 23.9K
#> 
#> bundle_path("/tmp/RtmpYLU9FH/bundle22455ffbb00d.tar.gz")
#> 
```
