...
#> Bundling directory (/tmp/RtmpSdnXLZ/bundledir234d3425c682)
#> Posit Connect Bundle: 
#>   Path: /tmp/RtmpSdnXLZ/bundle234d19c884aa.tar.gz
#>   Size: 23.9K
#> 
#> bundle_path("/tmp/RtmpSdnXLZ/bundle234d19c884aa.tar.gz")
#> 
```
