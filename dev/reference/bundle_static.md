...
#> Bundling directory (/tmp/Rtmpzt45gb/bundledir217536144f54)
#> Posit Connect Bundle: 
#>   Path: /tmp/Rtmpzt45gb/bundle2175424dee0a.tar.gz
#>   Size: 23.9K
#> 
#> bundle_path("/tmp/Rtmpzt45gb/bundle2175424dee0a.tar.gz")
#> 
```
