...
#> Bundling directory (/tmp/RtmpfD1mXr/bundledir24b637b49725)
#> Posit Connect Bundle: 
#>   Path: /tmp/RtmpfD1mXr/bundle24b61a9a6a62.tar.gz
#>   Size: 23.9K
#> 
#> bundle_path("/tmp/RtmpfD1mXr/bundle24b61a9a6a62.tar.gz")
#> 
```
