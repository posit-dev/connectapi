...
#> Bundling directory (/tmp/Rtmpfwqg58/bundledir22831d69e009)
#> Posit Connect Bundle: 
#>   Path: /tmp/Rtmpfwqg58/bundle2283679a3c7e.tar.gz
#>   Size: 23.9K
#> 
#> bundle_path("/tmp/Rtmpfwqg58/bundle2283679a3c7e.tar.gz")
#> 
```
