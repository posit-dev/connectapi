...
#> Bundling directory (/tmp/RtmpUKKNW8/bundledir22832464b1e9)
#> Posit Connect Bundle: 
#>   Path: /tmp/RtmpUKKNW8/bundle22833d476585.tar.gz
#>   Size: 23.9K
#> 
#> bundle_path("/tmp/RtmpUKKNW8/bundle22833d476585.tar.gz")
#> 
```
