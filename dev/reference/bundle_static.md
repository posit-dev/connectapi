...
#> Bundling directory (/tmp/Rtmpa4yK9B/bundledir24997b9df455)
#> Posit Connect Bundle: 
#>   Path: /tmp/Rtmpa4yK9B/bundle249917d9bb44.tar.gz
#>   Size: 23.9K
#> 
#> bundle_path("/tmp/Rtmpa4yK9B/bundle249917d9bb44.tar.gz")
#> 
```
