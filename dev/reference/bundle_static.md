...
#> Bundling directory (/tmp/RtmpBkQruq/bundledir235b743cfcd9)
#> Posit Connect Bundle: 
#>   Path: /tmp/RtmpBkQruq/bundle235b71655dea.tar.gz
#>   Size: 23.9K
#> 
#> bundle_path("/tmp/RtmpBkQruq/bundle235b71655dea.tar.gz")
#> 
```
