...
#> Bundling directory (/tmp/RtmpvjQrUr/bundledir236112cbcaf4)
#> Posit Connect Bundle: 
#>   Path: /tmp/RtmpvjQrUr/bundle236145e62870.tar.gz
#>   Size: 23.9K
#> 
#> bundle_path("/tmp/RtmpvjQrUr/bundle236145e62870.tar.gz")
#> 
```
