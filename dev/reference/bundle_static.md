...
#> Bundling directory (/tmp/RtmpJtYNa8/bundledir242d3ac6f5bd)
#> Posit Connect Bundle: 
#>   Path: /tmp/RtmpJtYNa8/bundle242d5913c7ec.tar.gz
#>   Size: 23.9K
#> 
#> bundle_path("/tmp/RtmpJtYNa8/bundle242d5913c7ec.tar.gz")
#> 
```
