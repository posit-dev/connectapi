...
#> Bundling directory (/tmp/RtmpEiIHlK/bundledir234063929883)
#> Posit Connect Bundle: 
#>   Path: /tmp/RtmpEiIHlK/bundle234066a556d0.tar.gz
#>   Size: 23.9K
#> 
#> bundle_path("/tmp/RtmpEiIHlK/bundle234066a556d0.tar.gz")
#> 
```
