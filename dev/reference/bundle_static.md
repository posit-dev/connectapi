...
#> Bundling directory (/tmp/Rtmpxg9RhH/bundledir22c53016a444)
#> Posit Connect Bundle: 
#>   Path: /tmp/Rtmpxg9RhH/bundle22c519962a2b.tar.gz
#>   Size: 23.9K
#> 
#> bundle_path("/tmp/Rtmpxg9RhH/bundle22c519962a2b.tar.gz")
#> 
```
